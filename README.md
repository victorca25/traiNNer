...
3) Most functions in transforms are reimplemented, except that:
   ...
   4) <font color=#00ffff>**All the outputs of the opencv version are almost the same as the original one(test in master/cvtorchvision/cvtransforms/cvfunctional.py:  if __name__ == '__main__':...)**</font>
## Support:
