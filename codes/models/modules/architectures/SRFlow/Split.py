...
from models.modules.architectures.glow.Step import FlowStep
from models.modules.architectures.glow.flow import Conv2dZeros, GaussianDiag
from options.options import opt_get


class Split2d(nn.Module):
    """ Modified from Glow Split2d
    """
