...
'''
TODO: currently there are two options to visualize flows, flow2rgb() and flow2img().
flow2img is not producing the expected color maps, flow2rgb is, needs more work to 
compare the two and check the results
'''
...
def flow2rgb(flow_map, max_value):
    #TODO: may need to remove batch before
    ...
    rgb_map = rgb_map.transpose(1, 2, 0)
