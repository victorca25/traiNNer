...
def main():
    ...
    for scheduler in model.schedulers:
        ...
        if opt["train"]["lr_scheme"] == "MultiStepLR" and (torch.__version__ == '1.4.0' or torch.__version__ == '1.4.1'):
    ...
    while current_step <= total_iters:
        for n, train_data in enumerate(train_loader, start=1):
            ...
            if current_step % opt["train"]["val_freq"] == 0:
                ...
                logger.info(
                    "# Validation # PSNR: {:.5g}, SSIM: {:.5g}, LPIPS: {:.5g}".format(
                ...
                logger_val.info(
                    "<epoch:{:3d}, iter:{:8,d}> psnr: {:.5g}, ssim: {:.5g}, lpips: {:.5g}".format(
