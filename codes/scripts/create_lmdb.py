...
# configurations
img_folder = (
    "/mnt/SSD/xtwang/BasicSR_datasets/DIV2K800/DIV2K800/*"  # glob matching pattern
)
lmdb_save_path = (
    "/mnt/SSD/xtwang/BasicSR_datasets/DIV2K800/DIV2K800.lmdb"  # must end with .lmdb
)
...
env = lmdb.open(
    lmdb_save_path, readonly=True, lock=False, readahead=False, meminit=False
)
